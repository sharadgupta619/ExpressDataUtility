package com.DataUtilityTransform.ExpressDataUtility.output.writers.instrumentation

import com.DataUtilityTransform.ExpressDataUtility.exceptions.ExpressDataUtility.WriteFailedException
...
import com.DataUtilityTransform.ExpressDataUtility.instrumentation.InstrumentationUtils
import com.DataUtilityTransform.ExpressDataUtility.output.MetricOutputWriter
import com.DataUtilityTransform.ExpressDataUtility.ExpressDataUtility.WriteFailedException
import com.DataUtilityTransform.ExpressDataUtility.instrumentation.InstrumentationUtils
import com.DataUtilityTransform.ExpressDataUtility.output.MetricOutputWriter
    ...
    dataFrame.foreach(row => {
      for ((column, i) <- columns) {
        try {
          ...
          case ex: Throwable => {
            throw ExpressDataUtility.WriteFailedException(s"failed to write instrumentation on data frame: $dataFrameName " +
